...
export default async function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center px-24 py-10">
      ...
      <div className="mb-32 text-center lg:max-w-5xl lg:w-full lg:mb-0 mt-9">
        <CustomLink
          href="api/auth/login" 
          textSize="text-2xl" 
